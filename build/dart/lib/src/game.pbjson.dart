...
const GameShareData$json = const {
  '1': 'GameShareData',
  '2': const [
...
final $typed_data.Uint8List gameShareDataDescriptor = $convert.base64Decode('Cg1HYW1lU2hhcmVEYXRhEhAKA2tleRgBIAEoCVIDa2V5');
...
const Game$json = const {
  ...
  '2': const [
    ...
    const {'1': 'share_data', '3': 7, '4': 1, '5': 11, '6': '.GameShareData', '10': 'shareData'},
  ],
};

/// Descriptor for `Game`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gameDescriptor = $convert.base64Decode('');
